  ...
  return (
    <div className='w-full flex gap-5 h-screen bg-zinc-900 p-20'>
        ...
        <div className='heading '>
             <h1 className='text-[6vw] uppercase leading-none font-semibold -mb-1'>Eye-</h1>
             <h1 className='text-[6vw] uppercase leading-none font-semibold -mb-1'>opening</h1>
        </div>
        ...
        <div className='w-1/2'>
        <h1 className='text-[6vw] uppercase leading-none font-semibold -mb-1'>presentation</h1>
        <div className='mt-10'>
        ...
        <p className='text-xl mt-10 front-light'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aliquid ad quaerat inventore ut vel architecto nam voluptatem harum excepturi corrupti doloremque quidem facere, ab temporibus esse provident eveniet. Cumque, quidem!</p>
